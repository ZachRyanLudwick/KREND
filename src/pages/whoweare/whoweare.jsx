...
const whoweare = () => {
  return (
    <main className="main-wrapper about-wrapper">
        <div className="about-container">
            <div className="row">
                <div className="col-md-12">
                    ...
                    <ul>
                        <li>Unmatched Expertise: Skilled professionals who know rendering inside and out.</li>
                        <li>Customer Satisfaction: Your vision is our priority, and we don’t leave until you’re happy.</li>
                        <li>Reliability You Can Count On: Timely service, transparent pricing, and no surprises.</li>
                        <li>Innovative Solutions: Modern techniques and materials that ensure long-lasting results.</li>
                        <li>Reachability: No matter where you are in the globe commercial or your own home we operate from all edges of the world.</li>
                    </ul>
                    <p>
                        From small domestic projects to large-scale commercial work, no job is too big or small for us. We pride ourselves on transforming properties and helping our customers achieve their dream spaces. Whether you’re refreshing your home’s exterior or upgrading your business premises, K-Render UK has you covered. Get in touch today to find out how we can help you render your property into something truly special.
                    </p>
                </div>
            </div>
        </div>
